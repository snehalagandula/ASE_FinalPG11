...
try
	...
	Class.forName("com.mysql.jdbc.Driver");
			...
			ResultSet rs=stmt.executeQuery("select password from adminlogin where username ='"+username+"'");
			...
			if(isRecoredFound){
				if(pass.equals(password)){
					RequestDispatcher rd=request.getRequestDispatcher("StudentSuccess.html");
